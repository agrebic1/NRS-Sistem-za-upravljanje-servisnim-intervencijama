...
| SBI-07-36 | Definisanje poslovnih pravila operativnog toka dispečera | Solution Architect | Done | Definisana pravila prelaska zahtjeva kroz operativne faze, razdvajanje korisničke hitnosti i operativnog prioriteta, ponašanje premium zahtjeva i dozvoljeni statusni prelazi unutar dispečerskog inboxa. |
| SBI-07-37 | Arhitekturno modeliranje životnog ciklusa zahtjeva i intervencija | Solution Architect | Done | Definisan standardizovani životni ciklus zahtjeva i trenutak prelaska zahtjeva u operativnu intervenciju, usklađeno između dashboarda, inboxa, detalja intervencije i baze podataka. |
| SBI-07-38 | Definisanje arhitekture operativnog dashboarda | Solution Architect + UX/UI | Done | Definisano da dashboard predstavlja sažeti operativni pregled (“command center”), a ne zamjenu za module Zahtjevi i Intervencije, uključujući KPI kartice, kratke sekcije i navigaciju prema detaljnim prikazima. |
| SBI-07-39 | Definisanje logike dispečerskog wizard toka | Solution Architect + Frontend support | Done | Definisana pravila višekoračnog dispečerskog čarobnjaka za određivanje prioriteta, uključujući conditional flow, premium scenarije i validaciju koraka. |
| SBI-07-40 | Definisanje pravila izmjene i otkazivanja zahtjeva | Solution Architect + Backend support | Done | Definisani uslovi pod kojima korisnik može izmijeniti ili otkazati zahtjev, uključujući ograničenja nakon početka dispečerske obrade i pravila audit evidencije. |
| SBI-07-41 | Validacija konzistentnosti operativne logike između modula | Solution Architect + QA | In Progress | Provjera usklađenosti statusa, prioriteta i operativnih pravila između korisničkog modula, dispečerskog inboxa, dashboarda i backend poslovne logike. |
