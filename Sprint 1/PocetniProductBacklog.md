...
|PB-009| Historija intervencija | Kao korisnik želim vidjeti historiju intervencija kako bih imao pregled prethodnih kvarova. | Feature | Srednji | 5 | To Do | Sprint 4 | AC:<br>1. Korisnik može vidjeti listu svih svojih prethodnih intervencija.<br> 2.Za svaku intervenciju prikazuju se osnovni podaci (datum, status, opis).<br>3. Lista je sortirana tako da su najnovije intervencije na vrhu. |
...
|PB-011| Potvrda zatvaranja intervencije | Kao korisnik želim potvrditi završetak intervencije kako bih bio siguran da je problem riješen. | Feature | Srednji | 3 | To Do | Sprint 4 | AC:<br>1. Korisnik ima opciju da potvrdi da je intervencija završena.<br> 2.Nakon potvrde status intervencije se postavlja na "Zatvoreno".<br>3. Ako korisnik ne potvrdi, intervencija ostaje u statusu "Završeno". |
