...
|:---|:--------------|:-------------|:------------|:-----------|:--------------------------------|:--------|:-------------------------------------|:----------|
|PB-001| Prijava kvara | Kao korisnik usluge želim da prijavim kvar unosom mjesta, lokacije i opisa kako bih pokrenuo proces servisiranja. | Feature | Visok | 5 | To Do | Sprint 2 (Razrada) / Release 1.0 | Osnovna funkcionalnost koja pokreće proces intervencije. |
...
|PB-006| Dodjela prioriteta | Kao dispečer želim da sistem predloži prioritet kvara koji ja potvrđujem ili korigujem, kako bi se najhitniji kvarovi riješili prvi. | Feature | Visok | 5 | To Do | Sprint 3 | Implementacija sistema koji asistira dispečeru pri odluci. |
|PB-007| Planiranje izlazaka na teren | Kao dispečer želim da vidim kalendar/listu dostupnosti servisera kako bi planiranje izlazaka na teren bilo efikasnije. | Feature | Visok | 8 | To Do | Sprint 3 (Dizajn) / Release 1.0 | Najkompleksniji dio poslovne logike koji je ključan za optimizaciju logistike. |
