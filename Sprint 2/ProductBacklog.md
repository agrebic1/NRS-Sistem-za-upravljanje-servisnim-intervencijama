...
|PB-008| Pregled operativnog statusa | Kao dispečer, želim vidjeti brojčani pregled intervencija po ključnim fazama (otvorene, u toku, završene) na početnom ekranu, kako bih odmah uočio obim posla. | Feature | Srednji | 3 | To Do | Sprint 3 | Vizuelni prikaz ključnih metrika za dispečera. |
...
|PB-011| Evidencija rada servisera | Kao serviser želim unijeti potrebne podatke, kako bih dokumentovao početak i završetak posla. | Feature | Srednji | 5 | To Do | Sprint 4 | Mogućnost unosa podataka kao što su utrošeno vrijeme, materijali, ishod i opis rješenja. |
