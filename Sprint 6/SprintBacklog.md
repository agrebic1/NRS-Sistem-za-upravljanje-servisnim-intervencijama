...
- priprema prenosa onboardinga internih uloga u Sprint 7 (US-35, US-18): finalizacija user story dokumentacije i potvrda scope-a "aplikacija -> admin odobravanje -> kreiranje naloga"
...
| SBI-06-22 | Prenos onboarding toka interne aplikacije u Sprint 7 (US-35 + US-18)          | Product owner + QA + Solution architect | In Progress | Dokumentovan je tok "slanje aplikacije -> status na_cekanju -> admin odobravanje -> kreiranje internog naloga"; implementacija i formalno zatvaranje planirani za Sprint 6.                   |
